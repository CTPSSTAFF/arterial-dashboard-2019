...
var getData = function(){ 
	...
	var szUrl = szWFSserverRoot + '?';
		...
		szUrl += '&typename=' + szWorkspace + 'ctps_cmp_2019_art_routes_ext_final';
...
var initDetailMap = function() {
	...
	var oDetailSpeedLayer = new ol.layer.Tile({	
		source: new ol.source.TileWMS({
			url		: szWMSserverRoot,
			params	: {
				'LAYERS': szWorkspace + 'ctps_cmp_2019_art_routes_ext_final',
				'STYLES': 'line',
				'TRANSPARENT': 'true'
			}
		}),
...
var initDownloadText = function() {
	...
	szTemp += "service=wfs";
	szTemp += "&typename=" + szWorkspace + "ctps_cmp_2019_art_routes_ext_final";
